...
<model-viewer camera-controls autoplay animation-name="" id="reveal" loading="eager" src="Models/Hello Again_Test_01.glb?sound=Sound/Hello Again_Test_.wav" ar="" ar-modes="scene-viewer webxr quick-look" ios-src="Hello Again_Test_01.usdz?sound=Sound/Hello Again_Test_.wav" alt="HelloAgain Test" auto-rotate-delay="0" ar-scale="auto" camera-controls="" style="width: 100%; height: 600px" exposure="0.5"> <button slot="ar-button" style="background-color: white; border-radius: 8px; border: 1 px solid black; position: absolute; top: 20px; right: 20px; "> 👋 AR Click Here </button>
